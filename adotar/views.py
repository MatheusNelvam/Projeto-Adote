...
def pedido_adocao(request, id_pet):
    ...
    if not pet.exists():
        messages.add_message(request, constants.WARNING, 'Desculpe, esse pet já foi adotado.')
    ...
    messages.add_message(request, constants.SUCCESS, 'Parabéns! Pedido de adoção realizado com sucesso.')
    return redirect('/adotar')    
